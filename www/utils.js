...
(function(exports) {
  ...
  function xor_encrypt(key, data) {
    var safedata = encodeURIComponent(data);
    var l = [];
    for (var i=0; i<safedata.length; i++) {
      l.push(safedata.charCodeAt(i) ^ keyCharAt(key, i));
    }
    return l;
  }
  ...
  function xor_decrypt(key, data) {
    ...
    for (var i=0; i<data.length; i++) {
      l.push(String.fromCharCode(data[i] ^ keyCharAt(key, i)));
    }
...
exports.encrypt = exports.XORCipher.encode;
exports.decrypt = exports.XORCipher.decode;
